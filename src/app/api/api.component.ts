  ...
  ngOnInit() {
    this.translation.onChange().subscribe({
      next: () => {
        ...
        this.whoIAm = this.translation.translate("home.whoIAm", {
          name: "Angular l10n"
        });
        this.description = this.translation.translate("home.description");

        this.formattedToday = this.intl.formatDate(this.today, {
          dateStyle: "full",
          timeStyle: "short"
        });
        this.formattedTimeAgo = this.intl.formatRelativeTime(
          this.timeAgo,
          "second",
          { numeric: "always", style: "long" }
        );
        this.formattedValue = this.intl.formatNumber(this.value, {
          digits: "1.2-2",
          style: "currency"
        });
      }
